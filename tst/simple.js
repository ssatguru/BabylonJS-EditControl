...
let addCamera = function (scene, canvas) {
  let camera = new BABYLON.ArcRotateCamera("ArcRotateCamera", Math.PI / 4, Math.PI / 4, 20, new BABYLON.Vector3(0, 0, 0), scene);
...
let addBox = function (scene) {
  ...
  box = BABYLON.MeshBuilder.CreateBox("box", { height: 5, width: 3, depth: 2 });
  box.material = mat;
